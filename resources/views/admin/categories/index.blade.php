        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="data-table" class="table table-bordered table-striped table-hover datatable datatable-category" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th width="10">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $category->id }}">
                                ...
                                <td>
                                    <a href="{{ Storage::url($category->image) }}">
                                       <img src="{{ Storage::url($category->image) }}" width="80" alt="">
                                    </a>
                                </td>
                                <td>
